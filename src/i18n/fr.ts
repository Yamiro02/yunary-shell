...
export const fr = {
  ...
  errors: {
    auth: {
      ...
      passwordTooShort: 'Le mot de passe est trop court (12 caractères minimum).',
  ...
  auth: {
    ...
    reset: {
      ...
      subtitle: 'Choisis un nouveau mot de passe (12 caractères minimum).',
  ...
  parametres: {
    ...
    password: {
      ...
      description: 'Choisis un nouveau mot de passe de 12 caractères minimum.',
